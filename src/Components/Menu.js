      ...
      >
        ...
        <div className="menu_inner">
          <div className="menu_logo text-center">
            <span>
              <img alt="logo" src={logo} className="img-responsive" />
            </span>
          </div>
          <h2 className="text-unselect">Games Portal</h2>
          ...
          <div className="foot_menu text-center">
            ...
            <p>
              <span className="text-unselect">Copyright © {new Date().getFullYear()} <br /> <b>Cashhub</b>{" "}</span>
            </p>
          </div>
        </div>
      </div>
